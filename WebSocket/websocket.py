...
class WebSocketConnection(asyncore.dispatcher_with_send):
	...
	def parse_connecting(self):
		print 'parse_connecting'
		header_end = self.buffer.find("\r\n\r\n")
		if header_end == -1:
			return
		else:
			print 'parse_connecting: find header_end'
...
if __name__ == "__main__":
	...
	WebSocketServer(port=5000, handlers={"/echo": EchoHandler})
	asyncore.loop() 